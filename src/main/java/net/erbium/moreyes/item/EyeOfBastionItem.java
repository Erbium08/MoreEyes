...
public class EyeOfBastionItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (world instanceof ServerWorld && (blockPos = (serverWorld = (ServerWorld)world).locateStructure(StructureTags.Structures.EYE_OF_BASTION_LOCATED, user.getBlockPos(), 100, false)) != null) {
