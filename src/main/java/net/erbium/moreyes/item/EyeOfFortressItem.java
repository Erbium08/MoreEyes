...
public class EyeOfFortressItem extends Item {
    public EyeOfFortressItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (world instanceof ServerWorld && (blockPos = (serverWorld = (ServerWorld)world).locateStructure(StructureTags.Structures.EYE_OF_FORTRESS_LOCATED, user.getBlockPos(), 100, false)) != null) {
